...
<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <div class="my-5">
      <input
        type="range"
        class="w-full bg-gray-200 accent-violet-500 hover:accent-violet-600"
        :min="MIN"
        :max="MAX"
        :step="STEP"
      ...
      <p class="text-center my-10 text-5xl font-extrabold text-rose-400">
        {{ formatearDinero(cantidad) }}
      </p>

      <h2 class="text-2xl font-extrabold text-gray-500 text-center">
        Elige un <span class="text-rose-400">plazo</span> a pagar
      </h2>
    ...
    <div v-if="total > 0" class="my-5 space-y-3 bg-gray-50 p-5">
      <h2 class="text-2xl font-extrabold text-gray-500 text-center">
        Resumen <span class="text-rose-400">de pagos</span>
      </h2>
